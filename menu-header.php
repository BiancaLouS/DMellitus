...
<body>
   ...
   ' <div id="carouselDiabetes" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">  
      <div class="carousel-item active">
        <img src="Img/IdosoModerno.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="Img/PaiFilho.jpg" class="d-block w-100" alt="...">
      </div>
